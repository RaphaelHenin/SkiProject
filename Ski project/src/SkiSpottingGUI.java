...
public class SkiSpottingGUI{
	...
	private void initialize() {
		...
		// Store nodes from the CSV "vertices_real_skiresort.csv" to an ArrayList (ReadCSVFile
		// function
		...
		// Store relations between each nodes from the CSV "relation_vertices_real_skiresort.csv" to an
		// ArrayList
